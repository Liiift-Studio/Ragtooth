...
export const RagText = forwardRef<HTMLElement, RagTextProps>(function RagText(
	{ children, as: Tag = 'p', sawDepth, sawPeriod, sawPhase, maxTracking, ragDifference, sawAlign, className, style },
	forwardedRef,
) {
	...
	const { ref } = useRag({ sawDepth, sawPeriod, sawPhase, maxTracking, ragDifference, sawAlign }, contentKey)
